...
(function() {
  ...
  $('#contactForm').on('submit', function(e) {
    ...
    if (isValid) {
      ...
      // Prepare template parameters (match these to your template variables)
      const templateParams = {
        name: nombre + ' ' + apellidos, // This should match the {{name}} variable in your template
        email: email,                  // This should match the {{email}} variable in your template
        telefono: telefono,            // This should match the {{telefono}} variable in your template
        message: mensaje               // This should match the {{message}} variable in your template
      };
